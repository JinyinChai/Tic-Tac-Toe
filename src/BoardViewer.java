...
public abstract class BoardViewer extends JPanel implements Observer, BoardStrategy {
	...
	public BoardViewer(Board aModel) {
		...
		try
		{
			Xs = ImageIO.read(getClass().getResourceAsStream("/x.png"));
			Os = ImageIO.read(getClass().getResourceAsStream("/o.png"));
	 ...
	 */
	public BoardViewer(Board aModel, Color backgroundColor, Color foregroundColor, Color lineColor,
			Color shapeColor) {
		this(aModel);
...
//				g2.draw(xLine);
//				g2.draw(xLine2);
				g2.drawImage(Xs, 25, 25, 50, 50, null);
...
//				g2.draw(circle);
				g2.drawImage(Os, 25, 25, 50, 50, null);
			}
			// the second square
...
//				g2.draw(xLine);
//				g2.draw(xLine2);
				g2.drawImage(Xs, 125, 25, 50, 50, null);
...
//				g2.draw(circle);
				g2.drawImage(Os, 125, 25, 50, 50, null);
			}
			// the third square
...
//				g2.draw(xLine);
//				g2.draw(xLine2);
				g2.drawImage(Xs, 225, 25, 50, 50, null);
...
//				g2.draw(circle);
				g2.drawImage(Os, 225, 25, 50, 50, null);
			}
			// the forth square
...
//				g2.draw(xLine);
//				g2.draw(xLine2);
				g2.drawImage(Xs, 25, 125, 50, 50, null);
...
//				g2.draw(circle);
				g2.drawImage(Os, 25, 125, 50, 50, null);
			}
			// the fifth square
...
//				g2.draw(xLine);
//				g2.draw(xLine2);
				g2.drawImage(Xs, 125, 125, 50, 50, null);
...
//				g2.draw(circle);
				g2.drawImage(Os, 125, 125, 50, 50, null);
			}
			// the sixth square
...
//				g2.draw(xLine);
//				g2.draw(xLine2);
				g2.drawImage(Xs, 225, 125, 50, 50, null);
...
//				g2.draw(circle);
				g2.drawImage(Os, 225, 125, 50, 50, null);
			}
			// the seventh square
...
//				g2.draw(xLine);
//				g2.draw(xLine2);
				g2.drawImage(Xs, 25, 225, 50, 50, null);
...
//				g2.draw(circle);
				g2.drawImage(Os, 25, 225, 50, 50, null);
			}
			// the eighth square
...
//				g2.draw(xLine);
//				g2.draw(xLine2);
				g2.drawImage(Xs, 125, 225, 50, 50, null);
...
//				g2.draw(circle);
				g2.drawImage(Os, 125, 225, 50, 50, null);
			}
			// the ninth square
...
//				g2.draw(xLine);
//				g2.draw(xLine2);
				g2.drawImage(Xs, 255, 225, 50, 50, null);
...
//				g2.draw(circle);
				g2.drawImage(Os, 255, 225, 50, 50, null);
			}
		}
